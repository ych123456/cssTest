...
//                            run.setFontFamily("微软雅黑");    
                            run.setFontSize(11);
                            run.setText(e.getValue().toString());    
							//删掉单元格内容
							c.removeParagraph(0);
	...
	public static void main(String[] args) {
		...
		changer.setTemplate("e:\\test\\ds.docx");
		Map<String,String> content = new HashMap<String,String>();
		content.put("Principles", "格式规范");
		content.put("Purpose", "规范会议操作");
		content.put("Scope", "公司会议");
//		
...
//		changer.fillTableAtBookMark("Table" ,content2);
		changer.fillTableAtBookMark("money", content2);
...
//		table.put("NUM_PRICE", "0.675");
		changer.replaceText(table,"table");
